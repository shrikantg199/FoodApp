...
function Homemain() {
  return (
    <div>
      <div class="sm:flex sm:justify-between sm:px-8  lg:px-10">
        <div class="w-full sm:w-2/3 mb-8 sm:mb-0 ">
          ...
          <h3 class="px-4 sm:px-0 py-4 sm:py-10 text-lg sm:text-2xl md:text-3xl lg:w-[50%] lg:mb-32">
        ...
        <div class="sm:w-1/3">
          <img
            src={img}
            alt=""
            class="mx-auto w-[400px] h-[400px] sm:m-0 rounded-full lg:w-[75%] lg:h-[50%] lg:mt-32"
          />
        </div>
      </div>
    </div>
